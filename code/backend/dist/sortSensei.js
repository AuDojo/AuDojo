...
exports.SortSensei = exports.SortType = void 0;
const sortProcessList_1 = require("./sortProcessList");
var SortType;
(function (SortType) {
    SortType[SortType["MergeSort"] = 0] = "MergeSort";
    SortType[SortType["QuickSort"] = 1] = "QuickSort";
    SortType[SortType["BubbleSort"] = 2] = "BubbleSort";
    SortType[SortType["SelectionSort"] = 3] = "SelectionSort";
    SortType[SortType["UNDEFINED"] = 4] = "UNDEFINED";
})(SortType || (exports.SortType = SortType = {}));
class SortSensei {
    static #processList = null;
    //constructor() {}
    /**
     ...
     */
    static createSortProcessList(list, sortType) {
        this.#processList = new sortProcessList_1.SortProcessList(list);
        ...
        switch (sortType) {
            ...
            default: //SortType = UNDEFINED -> gibt ein leeres Array zurück
                this.#processList = new sortProcessList_1.SortProcessList([]);
                break;
        }
     ...
     */
    static test(list, sortMode) {
        console.log(this.createSortProcessList(list, sortMode));
    }
}
exports.SortSensei = SortSensei;
